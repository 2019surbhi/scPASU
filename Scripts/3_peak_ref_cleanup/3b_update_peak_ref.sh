...
bam=${bam_dir}dedup_u10_uro_clean_filtered2_2_${strand}.bam
...
fprefix=u10_uro_filtered_100_${strand}
...
pcov_file=${outdir}u10_uro_filtered_100_${strand}_peak_count_updated.rds
fprefix=u10_uro_filtered_100_${strand}
w=11
h=8
x=100
