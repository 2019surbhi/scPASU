...
comp_file<-paste0(inputdir,'comp_group2.csv') # Note this is a different file for 1 vs all testing!
...
clus_lst<-create_apa_inputs(merged_counts,meta,c1=c1,c2='all',c1_nm=a[i],c2_nm='all',out=outdir,plot_corr = TRUE)
