...
peak_ref='/home/sonas/beegfs/APA/scPASU/output/3_RefinePeakRef/3d_final_ref/u10_uro_final.bed'
BAM='/home/sonas/beegfs/APA/scPASU/output/1_process_bam/1e_merged_bam/dedup_u10_uro_clean_filtered2_2_merged.bam'
out='/home/sonas/beegfs/APA/scPASU/output/7_UCSC_uploads/peak_filtered_bam/'

bedtools intersect -abam ${BAM} -b ${peak_ref} -s > ${out}u10_uro_peak_filtered.bam
...
bedtools intersect -abam ${bam_dir}${bam_pre}${clus}.bam -b ${peak_ref} > ${out}cluster${clus}_peak_filtered.bam
