...
bedtools intersect -a ${peaks_dir}peaks_${chr}_sorted_${strand}.bed -b ${polya_dir}polya_${chr}_sorted_${strand}.bed -wa -wb -loj -s > ${int_dir}peaks_int_polya_${chr}_${strand}.bed
