...
cols<-c('#FABED4','#BFEF45','#FFF0000','#FFBF00','#469990','#DF00FF','#800000','#000075')
...
png(paste0(outdir,'cluster',clusters[i],'.png'),width = 10,height = 8,units = "in",res = 600)
DimPlot(pobj,group.by = 'old_clusters',cells.highlight =  c(r1_bc,r2_bc),
        cols.highlight = cols[i],pt.size = 0.5)
dev.off()

png(paste0(outdir,'cluster',clusters[i],'_rep1.png'),width = 10,height = 8,units = "in",res = 600)
DimPlot(pobj,group.by = 'old_clusters',cells.highlight =  r1_bc,
        cols.highlight =cols[i],pt.size = 0.5)
dev.off()

png(paste0(outdir,'cluster',clusters[i],'_rep2.png'),width = 10,height = 8,units = "in",res = 600)
